...
class ImageProcessor:
    def __init__(self, folder_path, threshold_value):
    ...
    def morphological_transformations(self, mask):
    ...
    def process_images(self):
        ...
        for file_name in os.listdir(self.folder_path):
            ...
            if file_name.endswith('.JPG') or file_name.endswith('.jpg'):
                ...
                ret, thresholded_img = cv2.threshold(image_gray, 
    ...
    def write_to_csv(self):
        base_csv_path = r'D:\Research\Manganji2\23.12.2022\50deg\csv\B'
...
# Usage:
processor = ImageProcessor(r'D:\Research\Manganji2\23.12.2022\50deg\Before_Heat_Treatment\B\color', 10)
